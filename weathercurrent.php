...
<div class="row">
<div class="col-lg-6">
<h5 class="card-title font-weight-bold"><?php echo $characters['location'] ['city'] . ", " . $characters ['location'] ['region'];?></h5>
<h1 class="card-title font-weight-bold"><?php echo $characters ['current_observation']['condition']['temperature']; ?>&#176;</h1>
<p class="card-text"><?php echo date("D, M d"); ?>, <?php echo $characters ['current_observation'] ['condition']['text']; ?><br>
<?php echo "Humidity: " . $characters ['current_observation'] ['atmosphere']['humidity'] . "%"; ?><br>
<?php echo "Wind: " . $characters ['current_observation'] ['wind']['speed'] . " mph"; ?></p>
</div>
<div class="col-lg-6">
<?php echo $CurrentConditionImage; ?>
</div>
</div>